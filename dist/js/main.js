 ...
 */
function svgInline() {
  $('img[src*="svg"]').not('.preloader__img, .it__itImg').each(function () {
    let $img = $(this),
      imgID = $img.attr('id'),
...
el.document.ready(function () {
  ...
  $("a[href^='#'], [data-anchor]").click(function (e) {
    ...
    if (elDta.length) {
      ...
      if (nav.length && nav.css('position') === 'fixed' ||  true && el.documentH > el.windowtH) {
...
const init = () => {
	...
	_core_utils_functions_js__WEBPACK_IMPORTED_MODULE_0__/* .addLottieAnimation */ .MS('[data-lottie="preloader"]', 'others/lottie/preloader.json');
	setTimeout(() => {
		_core_utils_functions_js__WEBPACK_IMPORTED_MODULE_0__/* .addLottieAnimation */ .MS('[data-lottie="a"]', 'others/lottie/a.json');
		_core_utils_functions_js__WEBPACK_IMPORTED_MODULE_0__/* .addLottieAnimation */ .MS('[data-lottie="b"]', 'others/lottie/b.json');
		_core_utils_functions_js__WEBPACK_IMPORTED_MODULE_0__/* .addLottieAnimation */ .MS('[data-lottie="c"]', 'others/lottie/c.json');
